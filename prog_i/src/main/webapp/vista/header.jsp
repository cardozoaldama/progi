...
<html>
	<head>
		...
		<title>Header Principal JSP</title>
	</head>
	<body>
	 ...
	 --%>	
		<nav class="navbar navbar-dark bg-dark fixed-top">
			<div class="container-fluid">
				<a class="navbar-brand" href="#">Bienvenido ${sessionScope.usuario.nombre} a Programacion II</a>
				...
				<div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1"
					...
					<div class="offcanvas-body">
						<ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
							...
							<li class="nav-item"><a class="nav-link active" aria-current="page" href="articulo?action=registrarArticulos">Registrar artículo</a></li>
