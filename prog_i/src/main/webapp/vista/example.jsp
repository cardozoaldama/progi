			...
			<div class="table-responsive">
				<table class="table table-hover">
					...
					<tbody>
						...
						value="${articulo.idarticulo}"/></td>-->
						
						<td><c:out
						
						value="${articulo.codigo}"/></td>
						
						<td><c:out
						
						value="${articulo.nombre}"/></td>
						
						<td><c:out
						
						value="${articulo.descripcion}"/></td>
						
						<td><c:out
						
						value="${articulo.existencia}"/></td>
						
						<td><c:out
						
						value="${articulo.precio}"/></td>
						
						<td><a
						
						href="articulo?action=showedit&id=<c:out
						value="${articulo.idarticulo}" />">Editar</a></td>
						<td><a
						
						href="articulo?action=eliminar&id=<c:out
						value="${articulo.idarticulo}"/>">Eliminar</a> </td>
						</tr>
						</c:forEach>
